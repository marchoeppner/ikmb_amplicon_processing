...
## Assign taxonomy
###################
taxHS <- assignTaxonomy(seqtab.nochim, "/opt/sh_general_release_dynamic_02.02.2019.fasta", multithread=threads,tryRC=T) ## CHANGE to directory and pertinent database
#taxHS.Fs <- assignTaxonomy(seqtab.Fs.nochim, "/opt/sh_general_release_dynamic_10.10.2017_dev.fasta", multithread=threads,tryRC=T) ## CHANGE to directory and pertinent database
#taxHS.Rs <- assignTaxonomy(seqtab.Rs.nochim, "/opt/sh_general_release_dynamic_10.10.2017_dev.fasta", multithread=threads,tryRC=T) ## CHANGE to directory and pertinent database
